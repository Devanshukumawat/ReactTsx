...
const Footer: React.FC = () => {
  return (
    <footer className="bg-gradient-to-r from-blue-500 to-blue-600 text-white py-8">
            ...
            <div className="flex justify-around">
              <div>
                ...
                <ul className="space-y-2">
                  <li><Link to="#" className="text-sm hover:text-black">Home</Link></li>
                  <li><Link to="#" className="text-sm hover:text-black">About</Link></li>
                  <li><Link to="#" className="text-sm hover:text-black">Services</Link></li>
                  <li><Link to="#" className="text-sm hover:text-black">Contact</Link></li>
                </ul>
              </div>
              <div>
                <h2 className="text-lg font-semibold mb-4">Legal</h2>
                <ul className="space-y-2">
                  <li><Link to="#" className="text-sm hover:text-black">Privacy Policy</Link></li>
                  <li><Link to="#" className="text-sm hover:text-black">Terms of Service</Link></li>
                </ul>
              </div>
            </div>
          </div>
